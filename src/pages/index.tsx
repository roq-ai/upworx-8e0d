  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upworx: Empowering Owners, Recruiters, and Freelancers with seamless job offerings, applications, and contract management. Your all-in-one company account solution."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upworx: Empowering Owners, Recruiters, and Freelancers with seamless job offerings, applications, and contract management. Your all-in-one company account solution.`}
            </Text>
            <Box
